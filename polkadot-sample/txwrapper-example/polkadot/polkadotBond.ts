...
async function main(): Promise<void> {
  ...
  const blockHash = '0x4c4f559ad2d3bc044490486fa2f7318ef40fe6a10600debd7db3c53694a2d4f3';
  const blockNumber = 5698168;
  ...
  const unsigned = methods.staking.bond(
    {
      value: '10000000000',
      controller: '16eTevYtxg2hA2XimY1y7vV6CUga2EKhZQGKa9BvZpTcg5Ma', // Bob
      payee: 'Stash'
      // payee: 'Staked'
      // payee: 'Controller'
    },
    {
      address: '16eTevYtxg2hA2XimY1y7vV6CUga2EKhZQGKa9BvZpTcg5Ma',
      blockHash,
      blockNumber,
      eraPeriod: 128,
      genesisHash,
      metadataRpc: metadataRpc,
      nonce: 2, // Assuming this is Alice's first tx on the chain
      specVersion,
      tip: 0,
      transactionVersion,
    },
